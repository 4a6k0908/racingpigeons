...
public class LoginProc : MonoBehaviour
{
    ...
    {
        var exchangeSuccess = await _authManager.ExchangeAuthCodeForAccessToken(deepLinkUrl);
    ...
    private void onLoginClicked()
    {
        ...
        var loginUrl = _authManager.GetLoginUrl();
    ...
    private void onGoogleLoginClicked()
    {
        ...
        var loginUrl = _authManager.GetAuthUrl("Google");
        Application.OpenURL(loginUrl);
    ...
    private void onLineLoginClicked()
    {
        ...
        var loginUrl = _authManager.GetAuthUrl("Line");
        Application.OpenURL(loginUrl);
    ...
    {
        var successfulRefresh = await _authManager.CallRefreshTokenEndpoint();
